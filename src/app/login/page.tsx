...
function LoginForm() {
  ...
  return (
    ...
    >
      <div>
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.25rem', fontWeight: 700, color: 'var(--text-primary)', margin: 0 }}>
          Acesso restrito
        </h1>
      ...
      <button type="submit" className="btn btn--primary btn--block btn--lg" disabled={loading || !password}>
        {loading ? (
          <>
...
export default function LoginPage() {
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-app)', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: 380, display: 'flex', flexDirection: 'column', gap: 32, alignItems: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          <img src={logoBranco.src || logoBranco} alt="Fase Esporte" style={{ height: 48, objectFit: 'contain' }} />
